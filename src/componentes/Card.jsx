         ...
         <div className="container">
            <div className="card mb-3 mx-auto bg-dark text-light">
             ...
             <div className="col-md-4">
                 ...
                 <img src="https://images.pexels.com/photos/3573382/pexels-photo-3573382.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt=".." className="img-fluid rounded-start"/>
             </div>
          ...
          <h2 className="text-light no-select">Ingrese Datos</h2>
        )
       }
